...
- **Codes**
  ...
  - results_plots.ipynb: plots the obtained results (from cnn_test.ipynb) and compares them with SON observations of the DI.
- **Output figures**
  ...
  - son_di_hadisst_testing.pdf: time series of the SON Dipole Index (DI) from HadISST observations and CNN ensemble predictions at all lead times over the testing period.
